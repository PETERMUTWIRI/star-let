...
export function generateHomeMetadata(): Metadata {
  return createMetadata({
    title: 'Home',
    description:
      'Welcome to the official website of Ray Armillion. Discover soulful gospel music, upcoming events, and the inspiring journey of a Kenyan-American artist.',
    path: '/',
    keywords: [
      'official website',
      'home',
...
export function generateMusicMetadata(): Metadata {
  return createMetadata({
    title: 'Music',
    description:
      'Stream and download Ray Armillion\'s gospel and inspirational music. Explore albums, singles, and collaborations that celebrate faith and Kenyan heritage.',
    path: '/music',
    keywords: [
      'music streaming',
      'gospel albums',
...
export function generateVideosMetadata(): Metadata {
  return createMetadata({
    title: 'Videos',
    description:
      'Watch music videos, live performances, and behind-the-scenes content from Ray Armillion. Experience the energy of Kenyan-American gospel performances.',
    path: '/videos',
    keywords: [
      'music videos',
      'live performances',
...
export function generateEventsMetadata(): Metadata {
  return createMetadata({
    title: 'Events',
    description:
      'Find upcoming concerts, tours, and live performances by Ray Armillion. Get tickets and experience the powerful energy of live gospel music.',
    path: '/events',
    keywords: [
      'concerts',
      'tour dates',
...
export function generateAboutMetadata(): Metadata {
  return createMetadata({
    title: 'About',
    description:
      'Learn the inspiring story of Ray Armillion - from Kenyan refugee to gospel singer and cancer survivor. Discover her journey of resilience through music.',
    path: '/about',
    keywords: [
      'biography',
      'artist story',
...
export function generateBlogMetadata(): Metadata {
  return createMetadata({
    title: 'Blog',
    description:
      'Read the latest news, stories, and updates from Ray Armillion. Insights into music, faith, Kenyan culture, and the journey of an inspirational artist.',
    path: '/blog',
    keywords: [
      'blog',
      'news',
...
export function generateContactMetadata(): Metadata {
  return createMetadata({
    title: 'Contact',
    description:
      'Get in touch with Ray Armillion for bookings, press inquiries, collaborations, and fan messages. Connect with this Kenyan-American gospel artist today.',
    path: '/contact',
    keywords: [
      'contact',
      'bookings',
...
export function generatePrivacyMetadata(): Metadata {
  return createMetadata({
    ...
    description:
      'Privacy policy for Ray Armillion\'s official website. Learn how we collect, use, and protect your personal information and data privacy rights.',
    path: '/privacy',
    keywords: [
      'privacy policy',
      'data protection',
...
export function generateTermsMetadata(): Metadata {
  return createMetadata({
    ...
    description:
      'Terms and conditions for using Ray Armillion\'s official website. Read our terms of service, usage policies, and legal agreements.',
    path: '/terms',
    keywords: [
      'terms of service',
...
export function generateAccessibilityMetadata(): Metadata {
  return createMetadata({
    title: 'Accessibility',
    description:
      'Accessibility statement for Ray Armillion\'s website. Our commitment to making music and content accessible to all fans, regardless of ability.',
    path: '/accessibility',
    keywords: [
      'accessibility',
      'WCAG',
...
export function generateMusicTrackMetadata(params: MusicTrackMetadataParams): Metadata {
  ...
  return createMetadata({
    ...
    description: description || `Listen to ${title} by Ray Armillion. Available on all streaming platforms.`,
    path: `/music/${slug}`,
    ogImage: coverImage,
