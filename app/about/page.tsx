...
const pressQuotes = [
  {
    ...
    quote: 'Rahab Kinity embodies the spirit of resilience. Her performances bring communities together, celebrating both Kenyan heritage and American dreams.',
    rating: 5,
  },
  {
              ...
              <div className="relative">
                ...
                <div className="relative aspect-[4/5] rounded-3xl overflow-hidden glow-mixed">
                  <Image
                    ...
                    alt="Rahab Kinity - Kenyan Singer & Performer"
                    fill
            ...
            <div className="space-y-8">
              ...
              <ScrollReveal delay={0.2}>
                <div className="space-y-4 text-lg text-slate-300 leading-relaxed">
                  <p>
                    Born in Kenya and now calling America home, <span className="text-amber-400 font-medium">Rahab Kinity</span> brings 
              ...
              <div className="relative">
                ...
                <div className="relative bg-slate-900/50 rounded-3xl p-8 border border-white/10">
                  ...
                  <p className="text-xl text-slate-300 italic leading-relaxed mb-6">
                    "I want every person in the audience to leave feeling like they can overcome anything. 
                    Because if a girl from a refugee camp can stand here, in her traditional dress, 
                    having beaten cancer—then whatever you're facing, you can beat it too."
                  </p>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-semibold text-white">Rahab Kinity</div>
